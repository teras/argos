    ...
    fun domainCrossType_countAndSetConstraints() {
        class CountSetConstraintsArgs : Arguments(
            ...
            val testDomain by domain("test")
                ...
                .requireIfValue(::tags, ::verbosity) { it != null && it >= 2 }
