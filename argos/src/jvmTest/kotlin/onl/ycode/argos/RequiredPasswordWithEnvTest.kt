...
class RequiredPasswordWithEnvTest {
    ...
    fun requiredPassword_failsWhenNotProvidedAndEnvNotSet() {
        class PasswordArgs : Arguments() {
            val password by option("--password").password().fromEnv("TEST_PASSWORD").required()
        }
    ...
    fun requiredPassword_succeedsWhenProvidedViaEnvironmentVariable() {
        class PasswordArgs : Arguments() {
            val password by option("--password").password().fromEnv("PATH").required()
        }
    ...
    fun requiredPassword_multiplePasswordOptions_bothRequired() {
        class PasswordArgs : Arguments() {
            val userPassword by option("--user-password").password().fromEnv("USER_PASSWORD").required()
            val adminPassword by option("--admin-password").password().fromEnv("ADMIN_PASSWORD").required()
        }
    ...
    fun requiredPassword_withConstraints_successScenario() {
        class PasswordArgs : Arguments() {
            val dbPassword by option("--db-password").password().fromEnv("DB_PASSWORD").required()
    ...
    fun passwordSecurity_environmentVariableHandling() {
        ...
        class PasswordArgs : Arguments() {
            val password by option("--password").password().fromEnv("SECURE_PASSWORD")
        }
