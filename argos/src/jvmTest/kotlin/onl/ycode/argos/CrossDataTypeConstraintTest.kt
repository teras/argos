...
class CrossDataTypeConstraintTest {
    ...
    fun countOptionsWithConstraints() {
        ...
        class CountConstraints : Arguments(
            ...
            val alpha by domain("alpha")
            val verboseCount by option("-v", "--verbose").bool().count().atLeastOneWith(::quietCount)
            val quietCount by option("-q", "--quiet").bool().count()
            val debugInt by option("--debug-int").int().requireIfValue(::verboseCount) { it != null && it > 2 }
            val file by positional()
        }
        ...
        assertEquals(2, a1.verboseCount)
        assertEquals(0, a1.quietCount)
        ...
        assertEquals(3, a2.verboseCount)
        assertEquals(0, a2.quietCount)
        ...
        assertEquals(5, a3.verboseCount)
        assertEquals(0, a3.quietCount)
        ...
        assertEquals(0, a4.verboseCount)
        assertEquals(2, a4.quietCount)
