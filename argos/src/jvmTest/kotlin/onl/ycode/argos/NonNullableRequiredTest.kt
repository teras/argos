...
class NonNullableRequiredTest {
    ...
    fun testNonNullableCharArrayPasswordRequired() {
        class TestArgs : Arguments() {
            val password by option("--password").password().required() // Should be non-nullable CharArray
        }
    ...
    fun testMixedNullableAndNonNullable() {
        class TestArgs : Arguments() {
            ...
            val requiredPassword by option("--password").password().required() // Non-nullable CharArray
        }
    ...
    fun testNonNullableRequiredCount() {
        class TestArgs : Arguments() {
            val verbosity by option("-v", "--verbose").bool().count().required() // Should be non-nullable Int
        }
