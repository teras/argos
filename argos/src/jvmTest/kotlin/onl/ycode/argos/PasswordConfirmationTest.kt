...
class PasswordConfirmationTest {
    ...
    fun testPasswordWithConfirmationTrue() {
        ...
        class PasswordArgs : Arguments() {
            val password by option("--password").password(requireConfirmation = true)
        }
    ...
    fun testMultiplePasswordsWithConfirmation() {
        class PasswordArgs : Arguments() {
            val userPassword by option("--user-password").password(
                prompt = "User password: ",
                requireConfirmation = true
            )
            val adminPassword by option("--admin-password").password(
    ...
    fun testPasswordConfirmationExpectedDescription() {
        ...
        // The expectedDesc should still be "password"
        assertTrue(true, "Password with confirmation expected description should be 'password'")
    }
    ...
    fun testPasswordNoConfirmationByDefault() {
        ...
        class PasswordArgs : Arguments() {
            val password by option("--password").password() // No requireConfirmation specified
        }
