...
class DomainFragmentInheritanceTest {
    ...
    fun fragmentCannotHaveAliases() {
        assertFailsWith<ConfigError>("Fragments cannot have aliases") {
    ...
    fun fragmentCannotHaveLabel() {
        assertFailsWith<ConfigError>("Fragments cannot have labels") {
            class BadFragmentArgs : Arguments() {
                private val badFragment by domain(fragment = true)
                    .label("Bad Label")
            }
    ...
    fun fragmentCannotHaveHelp() {
        assertFailsWith<ConfigError>("Fragments cannot have help text") {
            class BadFragmentArgs : Arguments() {
                private val badFragment by domain(fragment = true)
                    .help("Bad help text")
            }
    ...
    fun fragmentCannotInherit() {
        assertFailsWith<ConfigError>("Fragments cannot inherit from other domains") {
            class BadFragmentArgs : Arguments() {
    ...
    fun inheritRequiresAtLeastOneDomain() {
        assertFailsWith<ConfigError>("inherits() requires at least 1 domain") {
