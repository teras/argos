...
abstract class CollectionOptionBuilder<T : Any, C : Collection<T>> internal constructor(
    ...
    override fun provideDelegate(thisRef: Arguments, property: KProperty<*>): ReadOnlyProperty<Arguments, C> {
        ...
        val actualNegationPrefix = negationPrefix ?: thisRef.getDefaultNegationPrefix()
                        ...
                        is SingleResult.Invalid -> {
                            ...
                            return@registerOption ParseOutcome.Error(
                                listOf(
                                    ...
                                    TextFragment(ContentStyle.PLAIN, r.value ?: "null"),
    ...
    /**
     * Adds validation for the entire collection after all elements are parsed.
     * This validation is applied to the complete collection, allowing validation
     * of collection-level properties like size, uniqueness, etc.
     *
     * @param message Error message to display if validation fails
